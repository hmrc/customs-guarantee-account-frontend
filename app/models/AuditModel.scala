...
case class GuaranteeCsvAuditData(eori: EORI, guaranteeAccountNumber: String, openOrClosed: String, asOfDateTime: String, fileFormat: String, from: Option[LocalDate], to: Option[LocalDate])
